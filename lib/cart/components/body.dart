                        ...
                        child: Row(
                          children: [
                            SizedBox(
                              width: 100,
                              height: 100,
                              child: Image.asset(cartdetails[index].products!.image!)),
                            Expanded(child: Text(cartdetails[index].products!.title)) ,
                            Expanded(child: Text(cartdetails[index].products!.price.toStringAsFixed(3) + Utilities.getCurrency())),
                            Expanded(child: Text(cartdetails[index].quantity.toString())),
